      ...
      <section className="flex flex-col gap-3">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-3">
          ...
          <a 
            ...
            className="glass-card p-3.5 flex flex-col justify-between h-[152px] group hover:border-indigo-400 hover:shadow-md transition-all cursor-pointer bg-white"
          >
            <div>
              ...
              <h2 className="text-[13.5px] font-bold text-slate-900 group-hover:text-indigo-600 transition-colors truncate">
                AI 행정 챗봇
              </h2>
              <p className="text-[11px] text-slate-500 mt-1 line-clamp-2 leading-snug h-[30px]">
          ...
          <a 
            ...
            target="_blank" 
            rel="noopener noreferrer"
            className="glass-card p-3.5 flex flex-col justify-between h-[152px] group hover:border-blue-400 hover:shadow-md transition-all cursor-pointer bg-white"
          >
            <div>
              <div className="flex items-center justify-between mb-2">
              ...
              <h2 className="text-[13.5px] font-bold text-slate-900 group-hover:text-blue-600 transition-colors truncate">
                스마트 여비정산기
              </h2>
              <p className="text-[11px] text-slate-500 mt-1 line-clamp-2 leading-snug h-[30px]">
          ...
          <Link 
            href="/archive" 
            className="glass-card p-3.5 flex flex-col justify-between h-[152px] group hover:border-emerald-400 hover:shadow-md transition-all cursor-pointer bg-white"
          >
            <div>
              <div className="flex items-center justify-between mb-2">
              ...
              <h2 className="text-[13.5px] font-bold text-slate-900 group-hover:text-emerald-600 transition-colors truncate">
                행정 자료실
              </h2>
              <p className="text-[11px] text-slate-500 mt-1 line-clamp-2 leading-snug h-[30px]">
          ...
          <Link 
            href="/board" 
            className="glass-card p-3.5 flex flex-col justify-between h-[152px] group hover:border-sky-400 hover:shadow-md transition-all cursor-pointer bg-white"
          >
            <div>
              <div className="flex items-center justify-between mb-2">
              ...
              <h2 className="text-[13.5px] font-bold text-slate-900 group-hover:text-sky-600 transition-colors truncate">
                소통 게시판
              </h2>
              <p className="text-[11px] text-slate-500 mt-1 line-clamp-2 leading-snug h-[30px]">
          ...
          <a 
            ...
            target="_blank" 
            rel="noopener noreferrer"
            className="glass-card p-3.5 flex flex-col justify-between h-[152px] group hover:border-amber-400 hover:shadow-md transition-all cursor-pointer bg-white"
          >
            <div>
              <div className="flex items-center justify-between mb-2">
              ...
              <h2 className="text-[13.5px] font-bold text-slate-900 group-hover:text-amber-600 transition-colors truncate">
                행정·민원 서식
              </h2>
              <p className="text-[11px] text-slate-500 mt-1 line-clamp-2 leading-snug h-[30px]">
          ...
          <a 
            ...
            target="_blank" 
            rel="noopener noreferrer"
            className="glass-card p-3.5 flex flex-col justify-between h-[152px] group hover:border-rose-400 hover:shadow-md transition-all cursor-pointer bg-white"
          >
            <div>
              <div className="flex items-center justify-between mb-2">
              ...
              <h2 className="text-[13.5px] font-bold text-slate-900 group-hover:text-rose-600 transition-colors truncate">
                수박 게임
              </h2>
              <p className="text-[11px] text-slate-500 mt-1 line-clamp-2 leading-snug h-[30px]">
            ...
            <div className="pt-2 border-t border-slate-100 flex items-center justify-between text-[11px] text-rose-600 font-bold">
              <span>게임 시작</span>
              <ChevronRight size={13} className="group-hover:translate-x-0.5 transition-transform" />
            </div>
          </a>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-3">
          ...
          <a 
            ...
            target="_blank" 
            rel="noopener noreferrer"
            className="glass-card p-3.5 flex flex-col justify-between h-[152px] group hover:border-violet-400 hover:shadow-md transition-all cursor-pointer bg-white"
          >
            <div>
              <div className="flex items-center justify-between mb-2">
              ...
              <h2 className="text-[13.5px] font-bold text-slate-900 group-hover:text-violet-600 transition-colors truncate">
                증빙서 측면표지
              </h2>
              <p className="text-[11px] text-slate-500 mt-1 line-clamp-2 leading-snug h-[30px]">
            ...
            <div className="pt-2 border-t border-slate-100 flex items-center justify-between text-[11px] text-violet-600 font-bold">
              <span>표지 만들기</span>
              <ChevronRight size={13} className="group-hover:translate-x-0.5 transition-transform" />
            </div>
          </a>
          ...
          <a 
            ...
            target="_blank" 
            rel="noopener noreferrer"
            className="glass-card p-3.5 flex flex-col justify-between h-[152px] group hover:border-teal-400 hover:shadow-md transition-all cursor-pointer bg-white"
          >
            <div>
              <div className="flex items-center justify-between mb-2">
              ...
              <h2 className="text-[13.5px] font-bold text-slate-900 group-hover:text-teal-600 transition-colors truncate">
                학교회계 대시보드
              </h2>
              <p className="text-[11px] text-slate-500 mt-1 line-clamp-2 leading-snug h-[30px]">
            ...
            <div className="pt-2 border-t border-slate-100 flex items-center justify-between text-[11px] text-teal-600 font-bold">
              <span>대시보드 열기</span>
              <ChevronRight size={13} className="group-hover:translate-x-0.5 transition-transform" />
            </div>
          </a>
          ...
          >
            <div>
              ...
              <h2 className="text-[13.5px] font-bold text-slate-900 group-hover:text-emerald-700 transition-colors truncate">
                엑셀시트 분리기
              </h2>
              <p className="text-[11px] text-slate-500 mt-1 line-clamp-2 leading-snug h-[30px]">
          ...
          <a 
            ...
            target="_blank" 
            rel="noopener noreferrer"
            className="glass-card p-3.5 flex flex-col justify-between h-[152px] group hover:border-orange-400 hover:shadow-md transition-all cursor-pointer bg-white"
          >
            <div>
              <div className="flex items-center justify-between mb-2">
              ...
              <h2 className="text-[13.5px] font-bold text-slate-900 group-hover:text-orange-600 transition-colors truncate">
                임금대장 식대분리
              </h2>
              <p className="text-[11px] text-slate-500 mt-1 line-clamp-2 leading-snug h-[30px]">
            ...
            <div className="pt-2 border-t border-slate-100 flex items-center justify-between text-[11px] text-orange-600 font-bold">
              <span>공제내역 추출</span>
              <ChevronRight size={13} className="group-hover:translate-x-0.5 transition-transform" />
            </div>
          </a>
          ...
          <a 
            ...
            target="_blank" 
            rel="noopener noreferrer"
            className="glass-card p-3.5 flex flex-col justify-between h-[152px] group hover:border-cyan-400 hover:shadow-md transition-all cursor-pointer bg-white"
          >
            <div>
              <div className="flex items-center justify-between mb-2">
              ...
              <h2 className="text-[13.5px] font-bold text-slate-900 group-hover:text-cyan-600 transition-colors truncate">
                교실배치도 제작기
              </h2>
              <p className="text-[11px] text-slate-500 mt-1 line-clamp-2 leading-snug h-[30px]">
            ...
            <div className="pt-2 border-t border-slate-100 flex items-center justify-between text-[11px] text-cyan-600 font-bold">
              <span>배치도 제작</span>
              <ChevronRight size={13} className="group-hover:translate-x-0.5 transition-transform" />
            </div>
          </a>
          ...
          <a 
            ...
            target="_blank" 
            rel="noopener noreferrer"
            className="glass-card p-3.5 flex flex-col justify-between h-[152px] group hover:border-pink-400 hover:shadow-md transition-all cursor-pointer bg-white"
          >
            <div>
              <div className="flex items-center justify-between mb-2">
              ...
              <h2 className="text-[13.5px] font-bold text-slate-900 group-hover:text-pink-600 transition-colors truncate">
                체육관 사용료
              </h2>
              <p className="text-[11px] text-slate-500 mt-1 line-clamp-2 leading-snug h-[30px]">
            ...
            <div className="pt-2 border-t border-slate-100 flex items-center justify-between text-[11px] text-pink-600 font-bold">
              <span>사용료 계산</span>
              <ChevronRight size={13} className="group-hover:translate-x-0.5 transition-transform" />
            </div>
          </a>
