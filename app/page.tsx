    ...
    <div className="w-full max-w-[1440px] mx-auto px-4 sm:px-6 py-2 sm:py-3 flex flex-col justify-between min-h-screen gap-2 sm:gap-3">
      ...
      <section className="w-full max-w-[1400px] mx-auto grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-2 sm:gap-2.5">
        ...
        >
          <div>
            <div className="flex items-center justify-between mb-1.5">
              <div className="w-8 h-8 rounded-xl bg-pink-50 text-pink-600 flex items-center justify-center border border-pink-100 group-hover:scale-105 transition-transform">
                <Calculator size={19} />
              </div>
              <div className="flex items-center gap-1">
