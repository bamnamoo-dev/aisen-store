...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-[#0b0f19] text-slate-100 flex flex-col items-center pb-20 overflow-x-hidden">
      ...
      {/* Background Accent - Subtle & Minimal */}
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full max-w-[1000px] h-[350px] bg-gradient-to-b from-blue-600/10 to-transparent pointer-events-none -z-10 blur-3xl"></div>

      {/* ========================================================
          FOLD 1: Hero & Simple Command Bar
      ======================================================== */}
      <section className="w-full max-w-[1100px] px-4 md:px-6 pt-8 md:pt-12 pb-10 flex flex-col items-center text-center">
        ...
        {/* Slim Metrics Bar */}
        <div className="w-full max-w-[840px] grid grid-cols-2 sm:grid-cols-4 gap-2 mt-8 p-3 rounded-xl bg-slate-900/30 border border-slate-800/80">
      ...
      ======================================================== */}
      <section className="w-full max-w-[1100px] px-4 md:px-6 py-4">
      ...
      {/* Footer */}
      <footer className="w-full max-w-[1100px] px-4 md:px-6 pt-8 mt-6 border-t border-slate-800/60 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-slate-500">
        <div>
