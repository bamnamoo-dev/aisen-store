    ...
    <div className="min-h-screen bg-slate-50 flex flex-col">
      ...
      <main className="flex-1 max-w-[912px] w-full mx-auto px-4 sm:px-6 py-8 sm:py-12 space-y-7 sm:space-y-8">
        ...
        <div className="bg-gradient-to-r from-blue-600 via-indigo-600 to-blue-700 rounded-3xl p-7 sm:p-8 text-white shadow-lg flex flex-col md:flex-row items-center justify-between gap-5">
          <div className="space-y-2.5 text-center md:text-left">
            <div className="flex flex-wrap items-center justify-center md:justify-start gap-2">
              <span className="bg-white/20 px-3 py-1 rounded-full text-xs sm:text-sm font-bold tracking-wide">100% 로컬 무부하 보안</span>
              <span className="bg-emerald-400 text-slate-900 px-2.5 py-1 rounded-full text-xs sm:text-sm font-black">서버 유출 0%</span>
              <span className="bg-blue-800/60 text-blue-100 px-3 py-1 rounded-full text-xs sm:text-sm font-semibold">전국 시도교육청 호환</span>
            </div>
            <h2 className="text-2xl sm:text-3xl font-black tracking-tight pt-1 leading-snug">
          ...
          <button 
            ...
            className="flex items-center gap-2 bg-white/10 hover:bg-white/20 border border-white/30 px-4.5 py-3 rounded-xl text-sm font-bold transition-all shrink-0 backdrop-blur-sm cursor-pointer hover:scale-[1.02] active:scale-[0.98]"
        ...
        <div className="bg-white rounded-3xl border border-slate-200 p-6 sm:p-7 shadow-sm space-y-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-2 bg-slate-100 p-1.5 rounded-2xl">
            <button
              ...
              className={`py-3 px-3 rounded-xl text-xs sm:text-sm font-bold transition-all flex items-center justify-center gap-2 cursor-pointer ${
          ...
          <div className="flex flex-wrap items-center justify-between gap-3 pt-1">
            <div className="flex flex-wrap items-center gap-2.5">
              ...
              <select
                ...
                className="bg-slate-50 border border-slate-300 rounded-xl px-3.5 py-2.5 text-xs sm:text-sm font-bold text-slate-800 focus:ring-2 focus:ring-blue-500 outline-none cursor-pointer"
              >
              ...
              <button
                ...
                className="flex items-center gap-2 bg-slate-100 hover:bg-slate-200 text-slate-700 text-xs sm:text-sm font-bold py-2.5 px-3.5 rounded-xl border border-slate-200 transition-colors cursor-pointer"
            ...
            {customRosterName && (
              <span className="text-xs sm:text-sm bg-blue-50 text-blue-700 font-bold px-3 py-1.5 rounded-xl border border-blue-200">
                {customRosterName}
              </span>
            )}
          </div>
        ...
        <div className="bg-white rounded-3xl border border-slate-200 p-6 sm:p-7 shadow-sm space-y-4">
          <div className="flex items-center justify-between border-b border-slate-100 pb-3.5">
            <div className="flex items-center gap-2.5">
              <span className="bg-indigo-50 text-indigo-700 text-xs sm:text-sm font-black px-2.5 py-1 rounded-lg border border-indigo-200">
                Step 2
              </span>
              <span className="font-black text-slate-800 text-base sm:text-lg flex items-center gap-2">
            ...
            {files.length > 0 && (
              <span className="text-xs sm:text-sm bg-emerald-50 text-emerald-700 font-black px-3.5 py-1 rounded-xl border border-emerald-200 flex items-center gap-1.5">
          ...
          >
            ...
            <div className="space-y-1.5">
              <div className="font-black text-slate-800 text-lg sm:text-xl">
            ...
            <span className="mt-2 bg-indigo-600 hover:bg-indigo-700 text-white text-sm sm:text-base font-extrabold px-6 py-3 rounded-xl transition-all shadow-xs group-hover:shadow-md">
          ...
          <div className="flex flex-wrap items-center gap-2.5 pt-1">
            <button
              ...
              className="flex-1 min-w-[220px] flex items-center justify-center gap-2 bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-700 hover:to-indigo-700 text-white text-xs sm:text-sm font-bold py-3 px-4 rounded-xl shadow-xs transition-all active:scale-95 disabled:opacity-50 cursor-pointer"
            ...
            <a
              ...
              className="flex items-center justify-center gap-1.5 bg-slate-50 hover:bg-slate-100 text-purple-700 border border-purple-200 text-xs sm:text-sm font-bold py-3 px-4 rounded-xl transition-colors shrink-0 shadow-xs"
            ...
            <button
              ...
              className="flex items-center justify-center gap-1.5 bg-slate-50 hover:bg-rose-50 text-rose-600 hover:text-rose-700 border border-rose-200 text-xs sm:text-sm font-bold py-3 px-4 rounded-xl transition-colors shrink-0 shadow-xs disabled:opacity-40 cursor-pointer"
