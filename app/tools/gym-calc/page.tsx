    ...
    <div className="w-full flex flex-col h-[calc(100vh-64px)] bg-slate-100 overflow-hidden relative">
      ...
      <div className="h-11 bg-white border-b border-slate-200 px-4 flex items-center justify-between shrink-0 z-20 shadow-2xs">
        <div className="flex items-center gap-3">
          <Link 
            href="/" 
            className="inline-flex items-center gap-1.5 text-xs font-bold text-slate-600 hover:text-pink-600 transition-colors bg-slate-100/80 hover:bg-pink-50 px-2.5 py-1 rounded-lg border border-slate-200"
          >
            <ArrowLeft size={13} />
          ...
          <div className="flex items-center gap-1.5">
            <div className="w-5 h-5 rounded-md bg-pink-50 text-pink-600 flex items-center justify-center font-bold text-xs">
              <Calculator size={13} />
            </div>
